...
variable "vm_name" {
    type = string
    default = "ubuntu-server-24.04-template"
}
...
locals {
    ...
    template_description = "Ubuntu Server Noble Numbat - Built on ${local.build_ts}"
    iso_url = "https://releases.ubuntu.com/24.04/${var.iso_file}"
...
source "proxmox-iso" "ubuntu-2404" {
    ...
    # VM ISO Settings
    # iso_url = local.iso_url # TODO: Warning: 'iso_url' is deprecated and will be removed in a future release, define the boot iso options in a 'boot_iso' block
    # iso_checksum = "${var.iso_checksum}" # TODO: Warning: 'iso_checksum' is deprecated and will be removed in a future release, define the boot iso options in a 'boot_iso' block
    # iso_storage_pool = "${var.iso_storage_pool}" # TODO: Warning: 'iso_storage_pool' is deprecated and will be removed in a future release, define the boot iso options in a 'boot_iso' block
    # unmount_iso = true # TODO: Warning: 'unmount_iso' is deprecated and will be removed in a future release, define the boot iso options in a 'boot_iso' block
